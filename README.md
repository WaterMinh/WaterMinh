...
Fourth-year Information Engineering student at Yuan Ze University, interested in backend development, automation, database systems, AI integration, and smart manufacturing.
...
**Tech:** Python, FastAPI, MySQL, SQLAlchemy, Docker, Jinja2, LM Studio

[View repository](https://github.com/WaterMinh/ai-course-assistant)
...
**Tech:** MySQL, SQL, Stored Procedures, Triggers, Views

[View repository](https://github.com/WaterMinh/hotel-management-database)
...
**Tech:** Python, Flask, LINE Messaging API, OpenAI API, Cloudflare Tunnel

[View repository](https://github.com/WaterMinh/line-openai-chatbot)
...
**Tech:** Python, pathlib, shutil, File System Automation

[View repository](https://github.com/WaterMinh/smart-file-organizer)
...
`MySQL` `SQLAlchemy` `Stored Procedures` `Triggers` `Views`

**AI and Automation**

`Local LLMs` `LM Studio` `OpenAI API` `Document Processing` `OCR` `Workflow Automation`

**Tools**

`Git` `GitHub` `GitHub Actions` `Docker` `Postman` `Cloudflare Tunnel` `Linux`
...
- System integration
- Smart manufacturing
- Manufacturing data applications
...
- GitHub: [WaterMinh](https://github.com/WaterMinh)
- Portfolio: [waterminh.github.io](https://waterminh.github.io/)
